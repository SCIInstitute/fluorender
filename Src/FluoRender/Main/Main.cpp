...
int main(int argc, char *argv[])
{
    ...
    app.setWindowIcon(QIcon(":FluoRender/FluoRender/UI/icons/FluoRender_icon.gif"));
    ...
    parser.addPositionalArgument("[file|project]", QCoreApplication::translate("main", "An image file or project to load."));
    ...
    std::cerr << "benchmark  " << benchmark << std::endl;
