...
|------------|-----------|----------|----------|
| [Version 2.34](https://github.com/SCIInstitute/fluorender/releases/download/v2.34/FluoRender2.34_win64.exe) | [Version 2.33](https://github.com/SCIInstitute/fluorender/releases/download/v2.33/FluoRender2.33_mac64_x86_64.pkg) | [Version 2.33](https://github.com/SCIInstitute/fluorender/releases/download/v2.33/FluoRender2.33_mac64_arm64.pkg) | [Email me](mailto:yong.wan@utah.edu) |
...
2) Build wxWidgets from the command line.
   ...
   * <code>../configure --disable-shared --with-cocoa --with-macosx-version-min=13.3 --enable-cxx11 --enable-stl --enable-std_containers --enable-std_iostreams --with-libpng=builtin --with-libtiff=builtin --with-libjpeg=builtin --with-zlib=builtin</code>
