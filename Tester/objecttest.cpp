...
void ObjectTest()
{
    ...
    ASSERT_TRUE(obj_list[1]->setValue("friend", static_cast<Referenced*>(obj_list[0].get())));
    Object* obj;

    //confirming the value has been added
    //ASSERT_TRUE(obj_list[1]->getValue("friend", (Referenced**)&obj));
    ASSERT_TRUE(obj_list[1]->getValue("friend",reinterpret_cast<Referenced**>(&obj)));
    ASSERT_EQ(obj1, obj);
    //modify obj2's value
    bval = true;
    ASSERT_TRUE(obj_list[0]->setValue("bval", bval));
    ...
    ASSERT_TRUE(obj_list[0]->getValue("friend",reinterpret_cast<Referenced**>(&obj)));
    ASSERT_EQ(0, obj);
   /* */
}
