                       ...
                       const wxPalette& palette)
{
    ...
    (void)Create(parent, id, pos, size, style, name, attribList, contextAttribList, palette);
}
...
void wxGLCanvas::GetPixelFormat(PIXELFORMATDESCRIPTOR *pfd) {
	if (pfd) memcpy((void*)pfd,(const void *)&m_pfd,sizeof(PIXELFORMATDESCRIPTOR));
}
...
bool wxGLCanvas::Create(wxWindow *parent,
                        ...
                        const wxPalette& palette)
{
	wxGLContext::m_glContextAttribs = contextAttribList;
...
bool wxGLCanvas::SetupPalette(const wxPalette& palette)
{
    ...
    if ( !::DescribePixelFormat(m_hDC, pixelFormat, sizeof(m_pfd), &m_pfd) )
    {
                       ...
                       const wxPalette& palette)
{
    ...
    if ( Create(parent, id, pos, size, style, name, attribList, NULL, palette) )
