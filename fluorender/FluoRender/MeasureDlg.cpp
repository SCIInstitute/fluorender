...
m_view(0)
{
	...
	m_toolbar->AddCheckTool(ID_LocatorBtn, "Locator",
		*PNG_RES::CreateBitmapFromPngResource("PNG_LISTICON_LOCATOR"),
		wxNullBitmap,
		"Add locators to the render view by clicking");
	m_toolbar->AddCheckTool(ID_RulerBtn, "2pt Ruler",
		*PNG_RES::CreateBitmapFromPngResource("PNG_LISTICON_ADDRULER"),
		wxNullBitmap,
	...
	m_toolbar->AddCheckTool(ID_RulerEditBtn, "Edit",
		*PNG_RES::CreateBitmapFromPngResource("PNG_LISTICON_RULEREDIT"),
		wxNullBitmap,
